...
gender_est_data_imp$prop_diff <- (gender_est_data_imp$estimate/gender_est_data_imp$measure_means_imp)

race_est_data_imp$prop_diff <- (race_est_data_imp$estimate/race_est_data_imp$measure_means_imp)

age_est_data_imp$prop_diff <- (age_est_data_imp$estimate/age_est_data_imp$measure_means_imp)
```
...
gender_est_data_imp$percent_diff <- percent(gender_est_data_imp$prop_diff)

race_est_data_imp$percent_diff <- percent(race_est_data_imp$prop_diff)

age_est_data_imp$percent_diff <- percent(age_est_data_imp$prop_diff)
```

```{r}
gender_est_data <- gender_est_data[c(1, 8, 2, 6, 7, 9, 10, 11)]

race_est_data <- race_est_data[c(1, 8, 2, 6, 7, 9, 10, 11)]

age_est_data <- age_est_data[c(1, 8, 2, 6, 7, 9, 10, 11)]

gender_est_data_imp <- gender_est_data_imp[c(1, 8, 2, 6, 7, 9, 10, 11)]

race_est_data_imp <- race_est_data_imp[c(1, 8, 2, 6, 7, 9, 10, 11)]

age_est_data_imp <- age_est_data_imp[c(1, 8, 2, 6, 7, 9, 10, 11)]
```
