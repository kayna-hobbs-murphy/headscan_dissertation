...
TrSel_C, TrTr_C, TrTr_L, TrSnas_C

```{r}
fourth_set_compare <- slice(.data = cor_icc_nas, c(23, 25, 26, 27))
fourth_set_compare <- select(.data = fourth_set_compare, c(1,24,26,27,28,29,30,31,32,33,34))
