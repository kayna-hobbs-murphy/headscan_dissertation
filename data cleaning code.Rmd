...
```{r}
save(headscan_full, file= "headscan_full")
write.csv(headscan_full, "C:\\Users\\19177\\OneDrive - Colostate\\Desktop\\Dissertation\\headscan_dissertation\\headscan_full.csv")
```
