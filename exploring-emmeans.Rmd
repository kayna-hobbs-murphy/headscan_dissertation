...
g_f_minus_m %>% 
  ...
  geom_text(hjust=-0.2, position = position_dodge(.9), size = 3)+
...
g_m_minus_f %>% 
  ggplot(aes(x=estimate, y= measure, label=estimate))+
  geom_bar(stat="identity", color= "black", fill = "white")+
  geom_text(hjust=1.1, position = position_dodge(.9), size = 3)+
  scale_x_continuous(expand = expansion(mult = 0.1))+
  theme_bw()+theme(text=element_text(family= "Times New Roman"))+
...
y_v_m %>% 
  ggplot(aes(x=estimate, y= measure, label=estimate))+
  geom_bar(stat="identity", color= "black", fill = "white")+
  geom_text(hjust=-0.1, position = position_dodge(.9), size = 3)+
  scale_x_continuous(expand = expansion(mult = 0.1))+
  theme_bw()+theme(text=element_text(family= "Times New Roman"))+
...
y_v_o %>% 
  ggplot(aes(x=estimate, y= measure, label=estimate))+
  geom_bar(stat="identity", color= "black", fill = "white")+
  geom_text(hjust=-0.15, position = position_dodge(.9), size = 3)+
  scale_x_continuous(expand = expansion(mult = 0.1))+
  theme_bw()+theme(text=element_text(family= "Times New Roman"))+
