...
age_est_data1$percent_diff <- percent(age_est_data1$prop_diff)
...
race_est_data1$percent_diff <- percent(race_est_data1$prop_diff)
```
...
race1.1 %>% 
  ...
  geom_bar(stat="identity", color= "black", fill = "white")+
  theme_bw()+theme(text=element_text(family= "Times New Roman"))+
  labs(title="Black - Asian Significant Differences (as Proportion of Measurement Mean)",
       subtitle= "Tukey significance level 0.05",
       y="Measurement Location",
       x="Proportion Difference = Estimated Difference/Measure Mean")
...
race2$measure <- fct_reorder(race2$measure, race2$percent_diff, .desc=FALSE)

race2 %>% 
  ggplot(aes(x=percent_diff, y= measure))+
  geom_bar(stat="identity", color= "black", fill = "white")+
  theme_bw()+theme(text=element_text(family= "Times New Roman"))+
  labs(title="Asian - LatinX Significant Differences as Percentage of Data Mean",
       subtitle= "Tukey significance level 0.05",
       y="Measurement Location",
