...
```{r}
all_outliers1 <- all_outliers1[c(1,2,15,3)]
...
(overlap between above numbers, total 25 outliers to change to NA)
...
```{r}
chosen_nona <- anti_join(chosen_data2, all_outliers1, by="ID")
str(chosen_nona)

chosen_nona <- chosen_nona %>% drop_na()


```


IMPUTE FOR PCA AND MANOVA WITH THIS DATASET, see imputing file
