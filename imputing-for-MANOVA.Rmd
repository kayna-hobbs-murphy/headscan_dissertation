...
##imputing multivariate outliers
...
sum(is.na(SA3_imputing))

SA3_imputing <- column_to_rownames(SA3_imputing, "ID")

which(SA3_imputing == "TRUE", arr.ind=TRUE)

SA3_imputing1 <- SA3_imputing[1:23,] <- NA

SA3_imputing1 <- rownames_to_column(SA3_imputing, "ID")
