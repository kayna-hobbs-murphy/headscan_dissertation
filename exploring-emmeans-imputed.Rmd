---
title: "exploring-emmeans-imputed"
output:
...
```{r}
gender_means_data <- read_excel("C:\\Users\\19177\\OneDrive - Colostate\\Desktop\\Dissertation\\headscan_dissertation\\gender_means_data1.xlsx")

race_means_data <- read_excel("C:\\Users\\19177\\OneDrive - Colostate\\Desktop\\Dissertation\\headscan_dissertation\\race_means_data1.xlsx")

age_means_data <- read_excel("C:\\Users\\19177\\OneDrive - Colostate\\Desktop\\Dissertation\\headscan_dissertation\\age_means_data1.xlsx")


gender_est_data <- read_excel("C:\\Users\\19177\\OneDrive - Colostate\\Desktop\\Dissertation\\headscan_dissertation\\gender_est_data1.xlsx")

race_est_data <- read_excel("C:\\Users\\19177\\OneDrive - Colostate\\Desktop\\Dissertation\\headscan_dissertation\\race_est_data1.xlsx")

age_est_data <- read_excel("C:\\Users\\19177\\OneDrive - Colostate\\Desktop\\Dissertation\\headscan_dissertation\\age_est_data1.xlsx")
```
...
gender_means_data %>% 
  ...
  labs(title="Estimated Marginal Means (Imputed) (Imputed)",
...
sig_gender_est %>% 
  ...
  geom_bar(position=position_dodge(), stat="identity")+
  theme_bw()+theme(text=element_text(family= "Times New Roman"))+
  labs(title="Gender Significant Differences in Estimated Marginal Means (Imputed) (Imputed)",
...
g_f_minus_m %>% 
  ...
  theme_bw()+theme(text=element_text(family= "Times New Roman"))+
  labs(title="Female/Other - Male Significant Differences in Estimated Marginal Means (Imputed) (Imputed)",
       subtitle= "Tukey significance level 0.05",
       y="Measurement Location",
       x="Difference in mm")
...
flextable(g_f_minus_m) %>%
  my_ft_theme()%>% 
  bold(part = "header") %>% 
  set_caption("Female/Other - Male Significant Differences in Estimated Marginal Means (Imputed) (Imputed)") %>% 
  fit_to_width(7.5) %>% 
  autofit()
```
...
age_est_data1 <- age_est_data1[c(1, 8, 2, 6, 9, 10)]
...
flextable(age_est_data1) %>%
  my_ft_theme()%>% 
  bold(part = "header") %>% 
  set_caption("Age-Related Significant Differences in Estimated Marginal Means (Imputed)") %>% 
  fit_to_width(7.5) %>% 
  autofit()
...
race4.1 %>% 
  ...
  geom_bar(stat="identity", color= "black", fill = "white")+
  theme_bw()+theme(text=element_text(family= "Times New Roman"))+
  labs(title="LatinX - Black Significant Differences in Estimated Marginal Means (Imputed)",
       subtitle= "Tukey significance level 0.05",
       y="Measurement Location",
       x="Difference in mm")
...
flextable(race4.1) %>%
  my_ft_theme()%>% 
  bold(part = "header") %>% 
  set_caption("LatinX - Black Significant Differences in Estimated Marginal Means (Imputed)") %>% 
  fit_to_width(7.5) %>% 
  autofit()
#```
