...
plot(fake$fitted.values, standardized)
abline(0,0)
abline(v = 0)
...
#create standardized residuals 
standardizedlog10 <- rstudent(fakelog10)
#create the fitted values 
#fittedlog10 <- scale(fakelog10$fitted.values)
```
...
resid1_log10 <- rstudent(manova_out_log10)
...
resid1_log <- rstudent(manova_out_log)
...
resid1_sqrt <- rstudent(manova_out_sqrt)
