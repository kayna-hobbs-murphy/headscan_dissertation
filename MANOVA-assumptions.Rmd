---
title: "MANOVA univariate outlier assessment"
...
flextable(AA_C_extreme) %>%
  my_ft_theme()%>% 
  bold(part = "header") %>% 
  set_caption("AA_C Extreme Outliers") 
...
flextable(BiW_C_extreme) %>%
  my_ft_theme()%>% 
  bold(part = "header") %>% 
  set_caption("BiW_C Extreme Outliers") 
...
flextable(BiW_L_extreme) %>%
  my_ft_theme()%>% 
  bold(part = "header") %>% 
  set_caption("BiW_L Extreme Outliers") 
...
flextable(GoSub_C_extreme) %>%
  my_ft_theme()%>% 
  bold(part = "header") %>% 
  set_caption("GoSub_C Extreme Outliers") 
...
flextable(NRB_L_extreme) %>%
  my_ft_theme()%>% 
  bold(part = "header") %>% 
  set_caption("NRB_L Extreme Outliers") 
...
flextable(ProS_L_extreme) %>%
  my_ft_theme()%>% 
  bold(part = "header") %>% 
  set_caption("ProS_L Extreme Outliers") 
...
flextable(SelP_L_extreme) %>%
  my_ft_theme()%>% 
  bold(part = "header") %>% 
  set_caption("SelP_L Extreme Outliers") 
...
flextable(SelM_L_extreme) %>%
  my_ft_theme()%>% 
  bold(part = "header") %>% 
  set_caption("SelM_L Extreme Outliers") 
...
flextable(SnasM_C_extreme) %>%
  my_ft_theme()%>% 
  bold(part = "header") %>% 
  set_caption("SnasM_C Extreme Outliers") 
...
flextable(TrSman_C_extreme) %>%
  my_ft_theme()%>% 
  bold(part = "header") %>% 
  set_caption("TrSman_C Extreme Outliers") 
...
flextable(TrTr_C_extreme) %>%
  my_ft_theme()%>% 
  bold(part = "header") %>% 
  set_caption("TrTr_C Extreme Outliers") 
...
flextable(TrTr_L_extreme) %>%
  my_ft_theme()%>% 
  bold(part = "header") %>% 
  set_caption("TrTr_L Extreme Outliers") 
