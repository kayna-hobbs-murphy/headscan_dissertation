...
Shapiro tests for normality not conducted due to large sample size (test may fail as a result). All plots of normality look good!




Box's test to check homogeneity of covariance
...
boxM(Y=boxtest_data[, c("AA_C", "BiW_C", "BiW_L", "GoSub_C", "NRB_L", "ProS_L",
           "SelP_L", "SelM_L", "SnasM_C", "SnasM_C", 
           "TrSman_C", "TrTr_C", "TrTr_L")], group=boxtest_data$race_eth)
