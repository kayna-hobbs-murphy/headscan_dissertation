...
quest_meas_nona1 %>% 
  ...
  annotate(geom="text", x=0.25, y=0.835, label= "Highly correlated measures with low intraRR", 
           size=3.5, fontface = 'italic', family= myFont1, hjust=0, vjust=0)+
  scale_shape_manual(values=seq(0,12))+
...
quest_meas_nona2 %>% 
  ...
  annotate(geom="text", x=0.02, y=0.27, label= "Highly correlated measures with low intraRR", 
           size=2.5, fontface = 'italic', family= myFont1, hjust=0, vjust=0)+
